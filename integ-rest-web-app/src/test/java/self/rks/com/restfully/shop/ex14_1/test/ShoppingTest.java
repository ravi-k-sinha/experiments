package self.rks.com.restfully.shop.ex14_1.test;

import self.rks.com.restfully.shop.ex14_1.domain.Customer;
import self.rks.com.restfully.shop.ex14_1.domain.Customers;
...
public class ShoppingTest
{
   ...
   private final String SHOP_URL = "http://localhost:8080/integ-rest-web-app/rapi/ex14_1/shop";
   ...
   {
      Response response = client.target(SHOP_URL).request().head();
       System.out.println("Response is " + response);
      Link products = response.getLink("products");
      response.close();

      System.out.println("** Populate Products");
       System.out.println("Products Link : " + products);
